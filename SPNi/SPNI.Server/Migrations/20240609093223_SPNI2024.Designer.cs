...
namespace SPNI.Server.Migrations
{
    ...
    [Migration("20240609093223_SPNI2024")]
    partial class SPNI2024
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPNI.Server.Model.Counutry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SPNI.Server.Model.OfficerInfo", b =>
                {
                    b.HasOne("SPNI.Server.Model.Counutry", "Counutry")
                        .WithMany("OfficerInfo")
                        .HasForeignKey("CounutryId");
