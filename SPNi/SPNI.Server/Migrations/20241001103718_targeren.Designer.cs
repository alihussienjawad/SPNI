...
namespace SPNI.Server.Migrations
{
    ...
    [Migration("20241001103718_targeren")]
    partial class targeren
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPNI.Models.News", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SPNI.Server.Model.ApplicationUserManageMinistry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApplicationUserManageMinistries");
                });
            ...
            modelBuilder.Entity("SPNI.Server.Model.OfficerInfo", b =>
                {
                    ...
                    b.Property<int>("RuleOfficerMinistryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RuleOfficerMinistryId");
            ...
            modelBuilder.Entity("SPNI.Server.Model.RuleOfficerMinistry", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("RuleOfficerMinistrys");
                });
            ...
            modelBuilder.Entity("SPNI.Server.Model.SpiAttitude", b =>
                {
                    ...
                    b.Property<string>("ActionTakenEn")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime>("EndDateToComplete")
                        .HasColumnType("datetime2");

                    b.Property<bool>("EndNotComplete")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime>("StartDateToComplete")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("SuggistionEn")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SPNI.Server.Model.Target", b =>
                {
                    ...
                    b.Property<int>("PerentTargetId")
                        .HasColumnType("int");

                    b.Property<int>("Sort")
                        .HasColumnType("int");

                    b.Property<int>("TargetScorr")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SPNI.Server.Model.TargetManageMinistry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TargetManageMinistries");
                });
            ...
            modelBuilder.Entity("SPNI.Models.News", b =>
                {
                    b.HasOne("SPNI.Server.Model.ApplicationUser", "ApplicationUser")
                        .WithMany("Newses")
            ...
            modelBuilder.Entity("SPNI.Server.Model.Images", b =>
                {
                    b.HasOne("SPNI.Server.Model.ApplicationUser", "User")
                        .WithMany("Imageses")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SPNI.Server.Model.OfficerInfo", b =>
                {
                    ...
                    b.HasOne("SPNI.Server.Model.RuleOfficerMinistry", "RuleOfficerMinistrys")
                        .WithMany("OfficerInfo")
                        .HasForeignKey("RuleOfficerMinistryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("RuleOfficerMinistrys");
                });
            ...
            modelBuilder.Entity("SPNI.Server.Model.RuleOfficerMinistry", b =>
                {
                    ...
                    b.Navigation("SubManageMinistrys");
                });
